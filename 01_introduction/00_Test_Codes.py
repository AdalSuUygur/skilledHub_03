...
# def get_valid_answer(question: str, valid_options: tuple) -> str: #uygun cevabı alana kadar kullanıcıya aynı soruyu soracağımız bir fonksiyon, utilities.
#     question += f' ({", ".join(valid_options)}): '

#     response = input(question)

#     while response.lower().strip() not in valid_options: #guardımız
...
#     print(
#         # Zaten hali hazırda giriş yapıldığı için boş data gelme ihtimalı yok.
#         # Bu yüzden get ile yazmadık.
...
# # test
# # print(
# #     get_valid_answer(question="Ek hesap devreye girsin mi?", valid_options=("e", "h"))
# # )

# input_amount = int(input("Please enter withdraw value: ")) or 0
...
#     else: #2.1
#         additional_balance = account.get("additional balance")
#         total_balance = balance + additional_balance #eğer total bakiyemiz çekilecekten daha yüksekse soralım aslında. 2.1.1.1

#         if additional_balance >= amount: 
#             #use_additional_balance = input("Ek hesap devreye girsin mi? (e/h): ") #2.1
#             #artık fonksiyonlu (guardlı) sorumuz çalışcak
#             use_additional_balance = get_valid_answer(question="Ek hesap devreye girsin mi?", valid_options=("e", "h"))

#             match use_additional_balance:
#                 case "e":
#                     detach_amount = amount - balance #ek hesaptan düşürülecek meblağ
#                     account["balance"] = 0 #acocuntaki hesabı sıfırladık.
#                     account["additional_balance"] -= detach_amount
#                     account_information(account=account)
...
#                 # case _:
#                 #zaten guardlı bir input sistemi yazdığımız için buraya gelmeyecek kod bloğu.

#         else:
#             print(
#                 "Yetersiz bakiye\n"
#                 "Ana sayfaya yönlendiriyorsunuz."
#                 )
#             account_information(account=account)
